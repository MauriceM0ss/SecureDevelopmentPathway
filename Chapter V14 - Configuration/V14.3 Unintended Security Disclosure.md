...
Het beleid van iRealisatie is dat op de Productie en Acceptatie omgevingen DEBUG logging niet ingeschakeld is.
...
Op dit moment is het nog in onderzoek. Beide het beleid moet gecheckt worden EN methodes van logging moet gecheckt worden. Zodra dit bekend is, kan dit punt aangevuld/ verbeterd worden. Op dit moment is de implementatie binnen iRealisatie nog onduidelijk.
